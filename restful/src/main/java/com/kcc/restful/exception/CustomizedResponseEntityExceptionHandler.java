...
// Provide to spring boot to handle errors
// Dedicated @ControllerAdvice exception when all controllers are running
@ControllerAdvice
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        ExceptionResponse e = new ExceptionResponse(new Date(), "Validation Fail", ex.getBindingResult().toString());
